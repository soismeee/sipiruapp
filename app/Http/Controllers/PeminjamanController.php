...
class PeminjamanController extends Controller
{
    ...
    public function jsonRiwayat()
    {
        ...
        $data = Peminjaman::with(['jadwal_aula', 'klien'])->select('id', 'klien_id', 'nama_peminjam', 'ja_id', 'waktu_awal', 'waktu_akhir', 'tanggal', 'keperluan', 'status_peminjaman')->where('status_peminjaman', '!=' ,'Pengajuan')->orderBy('id', 'DESC');
